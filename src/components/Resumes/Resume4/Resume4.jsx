  ...
  return (
    <>
        ...
        <div className="ColorFonts">
          ...
          <button className="DownloadPdf" onClick={() => { downloadPDF("resume4") }}>Download PDF</button>
        </div>


        <div className="ImageInserter">
          <input
            type="file"
            name="image"
        ...
        <div class="resume4" id="resume4">
          <div class="leftSide4">
            <div class="ProfileImage4" style={profileImageStyle}></div>
            <div class="Profile">
              <h1>Profile</h1>
              <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Aspernatur iure, vitae ipsam, explicabo, nostrum iste veniam
                laborum repellat animi excepturi quod ipsa sunt est odit autem
                consectetur harum iusto incidunt.
              </p>
            </div>
                    ...
                    <div key={index} className={`item item${index}`}>
                      <h4>
                        ...
                        <p className="TimePeriod">
                          {" "}
                          <span>{item.graduationStartYear}</span>{" "}
                          <span>-{item.graduationEndYear}</span>
                        </p>
                      </h4>
                      <p className="descriptionEdu">
